...
/* Generated from ../O.Common/ETH32AsynPortDriver.dbd */
...
epicsShareExtern reg_func pvar_func_ETH32AsynPortDriverRegister,
...
int ETH32AsynPortDriver_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/data/EPICS/project/ETH32";
    ...
    pvar_func_ETH32AsynPortDriverRegister();
...
/* ETH32AsynPortDriver_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ETH32AsynPortDriver_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ETH32AsynPortDriver_registerRecordDeviceDriver(*iocshPpdbbase);
}
