...
#define ANALOG_DI00X10                                                         \
  0x08 /* Difference of channel 0 and 0 (for calibration), with 10X gain */
...
typedef void(CALLCONVENTION *eth32_eventfn)(eth32 handle, eth32_event *event,
                                            void *extra);
...
// API Functions
eth32 CALLCONVENTION CALLEXTRA eth32_open(char *address, WORD port,
                                          unsigned int timeout, int *result);
int CALLCONVENTION CALLEXTRA eth32_set_timeout(eth32 handle,
                                               unsigned int timeout);
int CALLCONVENTION CALLEXTRA eth32_get_timeout(eth32 handle,
                                               unsigned int *timeout);
int CALLCONVENTION CALLEXTRA eth32_verify_connection(eth32 handle);
int CALLCONVENTION CALLEXTRA eth32_output_byte(eth32 handle, int port,
                                               int value);
int CALLCONVENTION CALLEXTRA eth32_output_bit(eth32 handle, int port, int bit,
                                              int value);
int CALLCONVENTION CALLEXTRA eth32_pulse_bit(eth32 handle, int port, int bit,
                                             int edge, int count);
int CALLCONVENTION CALLEXTRA eth32_set_led(eth32 handle, int led, int value);
int CALLCONVENTION CALLEXTRA eth32_input_byte(eth32 handle, int port,
                                              int *value);
int CALLCONVENTION CALLEXTRA eth32_input_successive(eth32 handle, int port,
                                                    int max, int *value,
                                                    int *status);
int CALLCONVENTION CALLEXTRA eth32_input_bit(eth32 handle, int port, int bit,
                                             int *value);
...
int CALLCONVENTION CALLEXTRA eth32_set_direction(eth32 handle, int port,
                                                 int direction);
int CALLCONVENTION CALLEXTRA eth32_get_direction(eth32 handle, int port,
                                                 int *direction);
int CALLCONVENTION CALLEXTRA eth32_set_direction_bit(eth32 handle, int port,
                                                     int bit, int direction);
int CALLCONVENTION CALLEXTRA eth32_get_direction_bit(eth32 handle, int port,
                                                     int bit, int *direction);
...
int CALLCONVENTION CALLEXTRA eth32_set_analog_reference(eth32 handle,
                                                        int reference);
int CALLCONVENTION CALLEXTRA eth32_get_analog_reference(eth32 handle,
                                                        int *reference);
int CALLCONVENTION CALLEXTRA eth32_input_analog(eth32 handle, int channel,
                                                int *value);
int CALLCONVENTION CALLEXTRA eth32_set_analog_eventdef(eth32 handle, int bank,
                                                       int channel, int lomark,
                                                       int himark,
                                                       int defaultval);
int CALLCONVENTION CALLEXTRA eth32_get_analog_eventdef(eth32 handle, int bank,
                                                       int channel, int *lomark,
                                                       int *himark);
int CALLCONVENTION CALLEXTRA eth32_set_analog_assignment(eth32 handle,
                                                         int channel,
                                                         int source);
int CALLCONVENTION CALLEXTRA eth32_get_analog_assignment(eth32 handle,
                                                         int channel,
                                                         int *source);
int CALLCONVENTION CALLEXTRA eth32_reset(eth32 handle);
int CALLCONVENTION CALLEXTRA eth32_get_serialnum(eth32 handle, int *batch,
                                                 int *unit);
int CALLCONVENTION CALLEXTRA eth32_get_serialnum_string(eth32 handle,
                                                        char *serial,
                                                        int bufsize);
int CALLCONVENTION CALLEXTRA eth32_get_product_id(eth32 handle, int *prodid);
int CALLCONVENTION CALLEXTRA eth32_get_firmware_release(eth32 handle,
                                                        int *major, int *minor);
int CALLCONVENTION CALLEXTRA eth32_connection_flags(eth32 handle, int reset,
                                                    int *flags);

int CALLCONVENTION CALLEXTRA eth32_set_event_queue_config(eth32 handle,
                                                          int maxsize,
                                                          int fullqueue);
int CALLCONVENTION CALLEXTRA eth32_get_event_queue_status(eth32 handle,
                                                          int *maxsize,
                                                          int *fullqueue,
                                                          int *cursize);
int CALLCONVENTION CALLEXTRA eth32_dequeue_event(eth32 handle,
                                                 eth32_event *event,
                                                 int timeout);
int CALLCONVENTION CALLEXTRA eth32_empty_event_queue(eth32 handle);
int CALLCONVENTION CALLEXTRA eth32_enable_event(eth32 handle, int type,
                                                int port, int bit, int id);
int CALLCONVENTION CALLEXTRA eth32_disable_event(eth32 handle, int type,
                                                 int port, int bit);
int CALLCONVENTION CALLEXTRA eth32_set_event_handler(eth32 handle,
                                                     eth32_handler *handler);
int CALLCONVENTION CALLEXTRA eth32_get_event_handler(eth32 handle,
                                                     eth32_handler *handler);

int CALLCONVENTION CALLEXTRA eth32_set_counter_state(eth32 handle, int counter,
                                                     int state);
int CALLCONVENTION CALLEXTRA eth32_get_counter_state(eth32 handle, int counter,
                                                     int *state);
int CALLCONVENTION CALLEXTRA eth32_set_counter_value(eth32 handle, int counter,
                                                     int value);
int CALLCONVENTION CALLEXTRA eth32_get_counter_value(eth32 handle, int counter,
                                                     int *value);
int CALLCONVENTION CALLEXTRA eth32_set_counter_rollover(eth32 handle,
                                                        int counter,
                                                        int rollover);
int CALLCONVENTION CALLEXTRA eth32_get_counter_rollover(eth32 handle,
                                                        int counter,
                                                        int *rollover);
int CALLCONVENTION CALLEXTRA eth32_set_counter_threshold(eth32 handle,
                                                         int counter,
                                                         int threshold);
int CALLCONVENTION CALLEXTRA eth32_get_counter_threshold(eth32 handle,
                                                         int counter,
                                                         int *threshold);

int CALLCONVENTION CALLEXTRA eth32_set_pwm_clock_state(eth32 handle, int state);
int CALLCONVENTION CALLEXTRA eth32_get_pwm_clock_state(eth32 handle,
                                                       int *state);
int CALLCONVENTION CALLEXTRA eth32_set_pwm_base_period(eth32 handle,
                                                       int period);
int CALLCONVENTION CALLEXTRA eth32_get_pwm_base_period(eth32 handle,
                                                       int *period);
int CALLCONVENTION CALLEXTRA eth32_set_pwm_channel(eth32 handle, int channel,
                                                   int state);
int CALLCONVENTION CALLEXTRA eth32_get_pwm_channel(eth32 handle, int channel,
                                                   int *state);
int CALLCONVENTION CALLEXTRA eth32_set_pwm_duty_period(eth32 handle,
                                                       int channel, int period);
int CALLCONVENTION CALLEXTRA eth32_get_pwm_duty_period(eth32 handle,
                                                       int channel,
                                                       int *period);

int CALLCONVENTION CALLEXTRA eth32_set_pwm_parameters(eth32 handle, int channel,
                                                      int state, float freq,
                                                      float duty);
int CALLCONVENTION CALLEXTRA eth32_get_pwm_parameters(eth32 handle, int channel,
                                                      int *state, float *freq,
                                                      float *duty);
...
// Interface name types that can be retrieved from the
// eth32cfg_plugin_interface_name function
...
typedef struct // IP address stored in binary form, in network order (first
               // octet stored at index 0)
{
...
int CALLCONVENTION CALLEXTRA eth32cfg_ip_to_string(
    const eth32cfg_ip_t *ipbinary,
    char *ipstring); // ipstring buffer MUST be at least 16 bytes long
int CALLCONVENTION CALLEXTRA eth32cfg_string_to_ip(const char *ipstring,
                                                   eth32cfg_ip_t *ipbinary);

eth32cfg CALLCONVENTION CALLEXTRA eth32cfg_query(eth32cfg_ip_t *bcastaddr,
                                                 int *number, int *result);
eth32cfg CALLCONVENTION CALLEXTRA eth32cfg_discover_ip(
    eth32cfg_ip_t *bcastaddr, unsigned int flags, unsigned char *mac,
    unsigned char product_id, unsigned short serialnum_batch,
    unsigned short serialnum_unit, int *number, int *result);
int CALLCONVENTION CALLEXTRA eth32cfg_get_config(eth32cfg handle, int index,
                                                 eth32cfg_data_t *dataptr);
int CALLCONVENTION CALLEXTRA eth32cfg_set_config(eth32cfg_ip_t *bcastaddr,
                                                 eth32cfg_data_t *dataptr);
int CALLCONVENTION CALLEXTRA eth32cfg_serialnum_string(unsigned char product_id,
...
eth32cfgiflist CALLCONVENTION CALLEXTRA
eth32cfg_plugin_interface_list(int *numd, int *result);
int CALLCONVENTION CALLEXTRA
eth32cfg_plugin_interface_address(eth32cfgiflist handle, int index,
                                  eth32cfg_ip_t *ip, eth32cfg_ip_t *netmask);
int CALLCONVENTION CALLEXTRA
eth32cfg_plugin_interface_type(eth32cfgiflist handle, int index, int *type);
int CALLCONVENTION CALLEXTRA eth32cfg_plugin_interface_name(
    eth32cfgiflist handle, int index, int nametype, char *name, int *length);
int CALLCONVENTION CALLEXTRA
eth32cfg_plugin_choose_interface(eth32cfgiflist handle, int index);
void CALLCONVENTION CALLEXTRA
eth32cfg_plugin_interface_list_free(eth32cfgiflist handle);
...
#define ETH_NETWORK_ERROR                                                      \
  -10 // unable to open, read, or write to the network socket
#define ETH_THREAD_ERROR                                                       \
  -11 // General error ocurred in the threads library used by this API.
#define ETH_NOT_SUPPORTED                                                      \
  -12 // returned if functionality is not supported by platform or device
...
#define ETH_WINDOWS_ERROR                                                      \
  -17 // Internal API error - specific to Windows platform
#define ETH_WINSOCK_ERROR                                                      \
  -18                        // Internal API error - specific to Windows sockets
#define ETH_NETWORK_INTR -19 // Network read/write operation was interrupted.
#define ETH_WRONG_MODE                                                         \
  -20 // Something is not configured correctly in order to allow this
      // functionality.
...
#define ETH_CFG_NOACK                                                          \
  -23 // Really a warning - no acknowledgement after configuring IP settings of
      // device
#define ETH_CFG_REJECT                                                         \
  -24 // The device refused to set its IP configuration settings
#define ETH_LOADLIB -25 // Error loading an external DLL library
#define ETH_PLUGIN                                                             \
  -26 // General error with plugin being used (for device discovery, sniffing,
      // etc)
...
#define ETH_INVALID_POINTER                                                    \
  -112 // Invalid pointer given as a parameter to an API function
#define ETH_INVALID_OTHER                                                      \
  -113 // Some parameter passed to an API function was invalid or out of range
...
#define ETH_TIMEOUT                                                            \
  -201 // Timeout ocurred. Most likely communication has been lost w/ device
